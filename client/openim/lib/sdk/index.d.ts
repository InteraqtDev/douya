...
declare class SDK extends Emitter {
    ...
    sendMessageByBuffer: (params: SendMsgParams, operationID?: string) => Promise<WsResponse<MessageItem>>;
    ...
    createSoundMessageByFile: (data: SoundMsgParams & {
        file: File;
    }, operationID?: string) => Promise<WsResponse<MessageItem>>;
    ...
    addBlack: <T>(data: string, ex?: string, operationID?: string) => Promise<WsResponse<T>>;
    ...
    signalingUpdateMeetingInfo: <T>(data: Partial<UpdateMeetingParams> & {
        roomID: string;
    }, operationID?: string) => Promise<WsResponse<T>>;
