(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.openImSdkWasm = {}));
  ...
  function registeMethodOnWindow(name, realName, needStringify = true) {
      console.info(`=> (database api) registe ${realName !== null && realName !== void 0 ? realName : name}`);
      return async (...args) => {
          if (!rpc || !worker) {
              initWorker();
          }
          ...
          try {
              console.info(`=> (invoked by go wasm) run ${realName !== null && realName !== void 0 ? realName : name} method with args ${JSON.stringify(args)}`);
              const response = await rpc.invoke(name, ...args, { timeout: 5000000 });
              console.info(`=> (invoked by go wasm) run ${realName !== null && realName !== void 0 ? realName : name} method with response `, JSON.stringify(response));
              if (!needStringify) {
                  return response;
              }
  ...
  const fileMapSet = registeMethodOnWindow('fileMapSet');
  const fileMapClear = registeMethodOnWindow('fileMapClear');
      ...
      constructor(url = '/openIM.wasm') {
          ...
          this.login = async (params, operationID = v4()) => {
              ...
              const config = {
                  ...
                  isLogStandardOutput: (_a = params.isLogStandardOutput) !== null && _a !== void 0 ? _a : true,
                  logFilePath: './',
          ...
          this.createImageMessage = (params, operationID = v4()) => {
          ...
          this.sendMessageByBuffer = (params, operationID = v4()) => {
              var _a;
              const offlinePushInfo = (_a = params.offlinePushInfo) !== null && _a !== void 0 ? _a : {
                  title: '你有一条新消息',
                  desc: '',
          ...
          this.getUsersInfoWithCache = (data, operationID = v4()) => {
          ...
          this.createSoundMessage = (data, operationID = v4()) => {
          ...
          this.createVideoMessage = (data, operationID = v4()) => {
          ...
          this.createFileMessage = (data, operationID = v4()) => {
          ...
          this.createFileMessageFromFullPath = (data, operationID = v4()) => {
          ...
          this.createVideoMessageFromFullPath = (data, operationID = v4()) => {
          ...
          this.setConversationEx = (data, operationID = v4()) => {
              return this._invoker('setConversationEx ', window.setConversationEx, [operationID, data.conversationID, data.ex]);
          };
          ...
          this.getFriendList = (operationID = v4()) => {
          ...
          this.pinFriends = (data, operationID = v4()) => {
              return this._invoker('pinFriends ', window.pinFriends, [
                  operationID,
                  JSON.stringify(data),
              ]);
          };
          this.setFriendsEx = (data, operationID = v4()) => {
              return this._invoker('setFriendsEx ', window.setFriendsEx, [
                  operationID,
          ...
          this.addBlack = (data, ex = '', operationID = v4()) => {
          ...
          this.fileMapSet = (uuid, file) => fileMapSet(uuid, file);
          initDatabaseAPI();
